...
namespace Langben.App.Controllers
{
    ...
    public class ITAbilityController : BaseController
    {
        ...
        public string GetList()
        {
            ...
            {
                List<ITAbility> list = m_BLL.GetByRefResumeId(CurrentAccount.resume.Id);
        ...
        public ActionResult CreateSave()
        {
            ...
            try
            {
                if (Request["Model"] != null)
                {
                    ...
                    Langben.DAL.ITAbility entity = js.Deserialize<Langben.DAL.ITAbility>(json);
                ...
                if (Request["Model"] != null)
                {
                    ...
                    {   //数据校验
                        ...
                        else
                        {
                            ...
                            LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，IT技能爱好信息的Id为" + entity.Id + "," + returnValue, "IT技能爱好");//写入日志   
                            result.Code = Common.ClientCode.Fail;
        ...
        public ActionResult Delete()
        {
            ...
            if (Request["ID"] != null)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.DeleteSucceed + "，IT技能爱好信息的Id为" + string.Join(",", deleteId), "消息"
                        );//删除成功，写入日志
                    result.Code = Common.ClientCode.Succeed;
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.DeleteFail + "，IT技能爱好信息的Id为" + string.Join(",", deleteId) + "," + returnValue, "消息"
                        );//删除失败，写入日志
                    result.Code = Common.ClientCode.Fail;
        ...
        {
            ITAbility Model = m_BLL.GetById(id);
            JavaScriptSerializer js = new JavaScriptSerializer();
        ...
        public ITAbilityController()
            : this(new ITAbilityBLL()) { }

        public ITAbilityController(ITAbilityBLL bll)
        {
            m_BLL = bll;
        }
