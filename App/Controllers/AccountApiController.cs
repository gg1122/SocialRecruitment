...
namespace Langben.App.Controllers
{
    ...
    public class AccountApiController : BaseApiController
    {
        ...
        /// <returns></returns>  
        public Common.ClientResult.Result Put([FromBody]DAL.Account entity)
        {
            Common.ClientResult.Result result = new Common.ClientResult.Result();
            if (entity != null && ModelState.IsValid)
            {   //数据校验
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.UpdateSucceed + "，会员信息的Id为" + entity.Id,"会员"
                        );//写入日志                   
                    result.Code = Common.ClientCode.Succeed;
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，会员信息的Id为" + entity.Id + "," + returnValue, "会员"
                        );//写入日志   
                    result.Code = Common.ClientCode.Fail;
