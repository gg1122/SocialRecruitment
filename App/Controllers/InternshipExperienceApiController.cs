...
namespace Langben.App.Controllers
{
    ...
    public class InternshipExperienceApiController : BaseApiController
    {
        ...
        {
            int total = 0;
            List<InternshipExperience> queryData = m_BLL.GetByParam(null, getParam.page, getParam.rows, getParam.order, getParam.sort, getParam.search, ref total);
            var data = new Common.ClientResult.DataResult
            {
                ...
                rows = queryData.Select(s => new
                {
					...
					,CompanyNature = s.CompanyNature
					,CompanyScale = s.CompanyScale
					,Job = s.Job
					,JobType = s.JobType
        ...
        /// <returns></returns>
        public InternshipExperience Get(string id)
        {
            InternshipExperience item = m_BLL.GetById(id);
            return item;
        }
        ...
        /// <returns></returns>
        public Common.ClientResult.Result Post([FromBody]InternshipExperience entity)
        {           
        ...
        /// <returns></returns>  
        public Common.ClientResult.Result Put([FromBody]InternshipExperience entity)
        {
            Common.ClientResult.Result result = new Common.ClientResult.Result();
            if (entity != null && ModelState.IsValid)
            {   //数据校验
        ...
        public InternshipExperienceApiController()
            : this(new InternshipExperienceBLL()) { }

        public InternshipExperienceApiController(InternshipExperienceBLL bll)
        {
            m_BLL = bll;
        }
