...
namespace Langben.App.Controllers
{
    ...
    /// 学历学校
    /// </summary>
    public class DegreeSchoolApiController : BaseApiController
    {
        /// <summary>
        /// 异步加载数据
        /// </summary>
        ...
        /// <returns></returns>
        public DegreeSchool Get(string id)
        {
            DegreeSchool item = m_BLL.GetById(id);
            return item;
        }
        ...
        /// <returns></returns>
        public Common.ClientResult.Result Post([FromBody]DegreeSchool entity)
        {           
        ...
        /// <returns></returns>  
        public Common.ClientResult.Result Put([FromBody]DegreeSchool entity)
        {
            Common.ClientResult.Result result = new Common.ClientResult.Result();
            if (entity != null && ModelState.IsValid)
            {   //数据校验
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，学历学校信息的Id为" + entity.Id + "," + returnValue, "学历学校"
                        );//写入日志   
                    result.Code = Common.ClientCode.Fail;
        ...
        public DegreeSchoolApiController()
            : this(new DegreeSchoolBLL()) { }

        public DegreeSchoolApiController(DegreeSchoolBLL bll)
        {
            m_BLL = bll;
        }
