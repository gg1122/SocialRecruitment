...
namespace Langben.App.Controllers
{
    ...
    public class FileUploaderApiController : BaseApiController
    {
        ...
        /// <returns></returns>
        public FileUploader Get(string id)
        {
        ...
        /// <returns></returns>
        public Common.ClientResult.Result Post([FromBody]FileUploader entity)
        {           
        ...
        /// <returns></returns>  
        public Common.ClientResult.Result Put([FromBody]FileUploader entity)
        {
            Common.ClientResult.Result result = new Common.ClientResult.Result();
            if (entity != null && ModelState.IsValid)
            {   //数据校验
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.UpdateSucceed + "，上传文件信息的Id为" + entity.Id,"上传文件"
                        );//写入日志                   
                    result.Code = Common.ClientCode.Succeed;
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，上传文件信息的Id为" + entity.Id + "," + returnValue, "上传文件"
                        );//写入日志   
                    result.Code = Common.ClientCode.Fail;
        ...
        public FileUploaderApiController(FileUploaderBLL bll)
        {
            m_BLL = bll;
        }
