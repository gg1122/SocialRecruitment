...
namespace Langben.App.Controllers
{
    ...
    /// 项目经验
    /// </summary>
    public class ProjectExperienceController : BaseController
    {
                ...
                if (Request["Model"] != null)
                {
                    ...
                    {   //数据校验
                        ...
                        else
                        {
                            ...
                            LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，项目经验信息的Id为" + entity.Id + "," + returnValue, "项目经验");//写入日志   
                            result.Code = Common.ClientCode.Fail;
        ...
        public ActionResult Delete()
        {
            ...
            if (Request["ID"] != null)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.DeleteSucceed + "，项目经验信息的Id为" + string.Join(",", deleteId), "消息"
                        );//删除成功，写入日志
                    result.Code = Common.ClientCode.Succeed;
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.DeleteFail + "，项目经验好信息的Id为" + string.Join(",", deleteId) + "," + returnValue, "消息"
                        );//删除失败，写入日志
                    result.Code = Common.ClientCode.Fail;
        ...
        public ProjectExperienceController()
            : this(new ProjectExperienceBLL()) { }

        public ProjectExperienceController(ProjectExperienceBLL bll)
        {
            m_BLL = bll;
        }
