...
---------------------------------
--上传简历
if exists(select * from dbo.sysobjects where id = object_id(N'[dbo].[Tri_Resume_FileUploader]') and OBJECTPROPERTY(id, N'IsTrigger') = 1)
drop trigger Tri_Resume_FileUploader
GO
Create TRIGGER Tri_Resume_FileUploader ON FileUploader 
FOR INSERT, UPDATE, Delete
AS
BEGIN
	declare @ResumeId nvarchar(36)	
