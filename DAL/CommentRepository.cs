...
namespace Langben.DAL
{
    ...
    /// 评论
    /// </summary>
    public partial class CommentRepository : BaseRepository<Comment>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<Comment> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<Comment>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条评论的主键</param>
        public void Delete(SysEntities db, string id)
        {
            Comment deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.Comment.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<Comment> collection = from f in db.Comment
