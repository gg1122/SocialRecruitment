...
namespace Langben.DAL
{
    ...
    public partial class SysEntities : DbContext
    {
        ...
        {
            var resumeIdParameter = resumeId != null ?
                new ObjectParameter("ResumeId", resumeId) :
                new ObjectParameter("ResumeId", typeof(string));
    
            var accountIdParameter = accountId != null ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Proc_Update_Resume_CompletionPercentage", resumeIdParameter, accountIdParameter);
        }
