...
namespace Langben.DAL
{
    ...
    public partial class FileUploaderRepository : BaseRepository<FileUploader>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<FileUploader> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <summary>
        /// 根据ResumeId，获取所有上传文件数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<FileUploader> GetByRefResumeId(SysEntities db, string id)
        {
            return from c in db.FileUploader
                        where c.ResumeId == id
                        select c;
