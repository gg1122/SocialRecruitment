...
namespace Langben.DAL
{
    ...
    public partial class SysNoticeRepository : BaseRepository<SysNotice>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<SysNotice> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>通知中心</returns>
        public SysNotice GetById(SysEntities db, string id)
        { 
