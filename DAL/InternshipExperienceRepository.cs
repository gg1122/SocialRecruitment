...
namespace Langben.DAL
{
    ...
    /// 实习经验
    /// </summary>
    public partial class InternshipExperienceRepository : BaseRepository<InternshipExperience>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<InternshipExperience> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<InternshipExperience>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条实习经验的主键</param>
        public void Delete(SysEntities db, string id)
        {
            InternshipExperience deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.InternshipExperience.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<InternshipExperience> collection = from f in db.InternshipExperience
