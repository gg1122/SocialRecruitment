...
namespace Langben.DAL
{
    ...
    /// 简历管理
    /// </summary>
    public partial class ResumeRepository : BaseRepository<Resume>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<Resume> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<Resume>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取简历管理---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>简历管理</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>简历管理</returns>
        public Resume GetById(SysEntities db, string id)
        { 
            return db.Resume.SingleOrDefault(s => s.Id == id);
        ...
        /// <param name="id">一条简历管理的主键</param>
        public void Delete(SysEntities db, string id)
        {
            Resume deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.Resume.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<Resume> collection = from f in db.Resume
