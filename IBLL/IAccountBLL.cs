...
namespace Langben.IBLL
{
    ...
    public partial interface IAccountBLL
    {
        ...
        /// <returns>结果集</returns>
        [OperationContract]
        List<DAL.Account> GetByParam(string id, int page, int rows, string order, string sort, string search, ref int total);
        /// <summary>
        /// 查询的数据
        /// </summary>
        /// <param name="id">额外的参数</param>
        ...
        /// <returns></returns>
        [OperationContract]
        System.Collections.Generic.List<DAL.Account> GetAll();
        ...
        /// <returns></returns>
        [OperationContract]
         bool Create(ref Common.ValidationErrors validationErrors, DAL.Account entity); 
        /// <summary>
        /// 删除一个对象
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        ...
        /// <returns></returns>
        [OperationContract]
        bool Edit(ref Common.ValidationErrors validationErrors, DAL.Account entity); 
