...
namespace Langben.BLL
{
    ...
    public partial class FileUploaderBLL :  IBLL.IFileUploaderBLL, IDisposable
    {
        ...
        {
            IQueryable<FileUploader> queryData = repository.GetData(db, order, sort, search);
        ...
        /// <param name="entity">一个上传文件</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="entitys">上传文件集合</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="deleteCollection">上传文件的集合</param>
        /// <returns></returns>    
        ...
        /// 根据主键获取一个上传文件
        /// </summary>
        /// <param name="id">上传文件的主键</param>
        /// <returns>一个上传文件</returns>
        ...
        /// <summary>
        /// 根据ResumeIdId，获取所有上传文件数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public List<FileUploader> GetByRefResumeId(string id)
        {
